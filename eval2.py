...
load_params = torch.load(os.path.join('/home/snowflake/Escritorio/PyTorch-BYOL/runs/Jun03_14-42-21_snowflake/checkpoints/model.pth'),
...
+ contrastive learning with negatives: 91.5/9
+ Stochastic Weight Averaging (SWA): 91.7/92.1
+ 400 epochs: 91.9
+ acumulation steps 2: 92.3
(more epochs and more acum steps the better)
